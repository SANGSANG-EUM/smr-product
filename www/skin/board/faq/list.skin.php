...
<div id="faq_list" class="sub faq">
  <?php sub_top($sb_menus, 'community', 'faq'); ?>
              ...
              <ul class="faq_ul">
                ...
                <li class="faq_in">
                  ...
                  <div class="faq_q">
                    ...
                    <?php if ($is_checkbox) { ?>
                    <a href="/<?php echo $bo_table?>/write?w=u&wr_id=<?=$list[$i]['wr_id']?>" class="bo_btn1 faq_edit_btn">수정</a>
                    <?php }else{ ?>
...
$(document).ready(function(){
  $(".faq_in").on("click",function(){
    if($(this).hasClass('active')) {
      $(this).removeClass("active").find(".faq_a").slideUp(200);
    } else {
      $(this).addClass("active").find(".faq_a").slideDown(200);
    }
    $(this).siblings().removeClass("active").find(".faq_a").slideUp(200);
  });
});
</script>
