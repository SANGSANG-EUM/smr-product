...
<div id="inquiry_view" class="sub inquiry">
    ...
    <div class="container">
      <div class="wrapper">
        ...
        <section class="board-view">
          <h2 class="sound_only">Contact Us > View</h2>
          <div class="sec_ct">
            ...
            <div class="board-v-cont">
              Name : <?php echo $view['wr_name']; ?><br/>
              E-mail : <?php echo $view['wr_1']; ?>@<?php echo $view['wr_2']; ?><br>
              Questions : <?php echo get_view_thumbnail($view['content']); ?>
            </div>
            ...
            <div id="bo_v_bot">
              ...
              <ul class="btn_bo_user bo_v_com">
                <?php if ($update_href) { ?>
                <!-- <li>
                  <a href="<?php echo $update_href ?>" class="bo_btn2">Edit</a>
                </li> -->
                <?php } ?>
                <?php if ($delete_href) { ?>
                <li>
                  <a href="<?php echo $delete_href ?>" class="bo_btn3" onclick="del(this.href); return false;">Delete</a>
                </li>
                <?php } ?>
              </ul>
              <?php
